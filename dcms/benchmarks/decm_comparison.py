...
dcm_comparison, dwcm_comparison and qdecm_comparison benchmarks.
...
_ALL_METHODS: list[dict] = [
    ...
    {"name": "θ-Newton Anderson(10) [qdecm]",   "ic": "qdecm",   "variant": "theta-newton", "anderson_depth": 10},
...
# Fast mode: degrees (default) + qdecm warm-start (most robust for large N).
...
def _print_aggregate_table(
    ...
    """Print the aggregate statistics table (same format as qdecm_comparison).
