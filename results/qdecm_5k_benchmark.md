# qDECM N=5,000 Benchmark

**Command:**
```
python -m src.benchmarks.qdecm_comparison --sizes 5000 --n_seeds 5 --start_seed 0 --timeout 0 --fast
```
...
- The weight solver fixes (PR#12 continuation + bad-seed fixes in `fixed_point_qdecm.py`):
